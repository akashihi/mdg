...
const accountSchema: JTDSchemaType<
    Model.Account,
    { category: Model.Category; currency: Model.Currency; account: Model.Account }
> = {
    definitions: {
...
const accountListSchema: JTDSchemaType<
...
const accountTreeSchema: JTDSchemaType<
    { asset: Model.AccountTreeNode; expense: Model.AccountTreeNode; income: Model.AccountTreeNode },
    {
        category: Model.Category;
        currency: Model.Currency;
        account: Model.Account;
        accountTreeNode: Model.AccountTreeNode;
    }
> = {
    definitions: {
        category: categoryDefinition as JTDSchemaType<
