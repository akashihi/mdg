...
const transactionSchema: JTDSchemaType<
    Model.Transaction,
    {
...
> = {
    definitions: {
        ...
        >,
        operation: operationDefinition as JTDSchemaType<
            Model.Operation,
            {
                category: Model.Category;
                currency: Model.Currency;
        ...
        >,
        transaction: transactionDefinition as JTDSchemaType<
            Model.Transaction,
            {
                category: Model.Category;
                currency: Model.Currency;
...
const transactionListSchema: JTDSchemaType<
    TransactionList,
    {
        category: Model.Category;
        currency: Model.Currency;
...
export async function listTransactions(
    filter: Partial<TransactionFilterParams>,
    limit: number
): Promise<Result<TransactionList, Model.Problem>> {
...
export async function saveTransaction(
    transaction: Model.Transaction
): Promise<Result<Model.Transaction, Model.Problem>> {
