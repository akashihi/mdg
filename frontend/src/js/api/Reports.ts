...
export async function loadAssetReport(type: string, params: ReportParams): Promise<Result<Model.Report, Model.Problem>> {
...
export async function loadEventsReport(type: string, params: ReportParams): Promise<Result<Model.PieData, Model.Problem>> {
...
export async function loadBudgetReport(params: ReportParams): Promise<Result<Model.BudgetExecutionReport, Model.Problem>> {
