...
function accountList(tree: AccountTreeNode, indent: number, currencyFilter?: number) {
    ...
    if (tree.id !== undefined) {
        ...
        }}/>].concat(accounts).concat(subCategories)
    }
    return accounts.concat(subCategories)
}

export function accountMenu(asset: AccountTreeNode, income: AccountTreeNode, expense: AccountTreeNode, currencyFilter?: number) {
    ...
    return [<ListSubheader key='asset-header'>Asset accounts</ListSubheader>,<Divider key='asset-divider'/>]
        ...
        .concat([<ListSubheader key='expense-header'>Expense accounts</ListSubheader>,<Divider key='expense-divider'/>])
