...
export const selectPrimaryCurrency = createSelector(
    [getCurrencies, selectPrimaryCurrencyId], (currencies: Currency[], primaryId: number): Currency | undefined => currencies.find(c => c.id === primaryId))

export const selectPrimaryCurrencyName = createSelector(
    [selectPrimaryCurrency], (primaryCurrency: Currency | undefined): string => {
