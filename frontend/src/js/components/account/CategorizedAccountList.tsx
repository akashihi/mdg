...
function CategorizedAccountList(props: CategorizedAccountListProps) {
    const subCategories = props.tree.categories.map(c => <CategorizedAccountList key={c.id} tree={c} indent={props.indent+1} hidden={props.hidden} accountEdit={props.accountEdit}/>);
