...
function AccountDialog(props) {
    ...
    const onSubmit = (values) => {
        props.actions.editAccountSave(Map(values));
    };

    const onCancelClick = () => {
        props.actions.editAccountCancel();
    };
            ...
            {({submitForm, isSubmitting, values}) => (
                <Form>
                    <DialogContent>
                        ...
                        <Field type='text' name='name' label='Account name' value={values.name} component={TextField}
                               className='common-field-width'/>
                        ...
                        <Field
                            ...
                            component={TextField}
                            className='common-field-width'>
                            {mapCategoryListToMenu(props.categoryList.filter((v) => v.get('account_type') === values.account_type))}
                        </Field>
                        <br/>
