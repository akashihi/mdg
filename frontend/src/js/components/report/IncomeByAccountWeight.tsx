...
export function IncomeByAccountWeight(props: ReportProps) {
    ...
    useEffect(() => {
        ...
        const url = `/api/reports/income/accounts/${reportDatesToParams(props)}`;
...
export default IncomeByAccountWeight;
