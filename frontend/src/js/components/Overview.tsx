    ...
    return (
        <Grid container spacing={2}>
            <Grid item xs={12} sm={12} md={12} lg={6}>
                <Card style={cardStyle}>{chooseWidget(props.overview.lt)}</Card>
            </Grid>
            <Grid item xs={12} sm={12} md={12} lg={6}>
                <Card style={cardStyle}>{chooseWidget(props.overview.rt)}</Card>
            </Grid>
            <Grid item xs={12} sm={12} md={12} lg={6}>
                <Card style={cardStyle}>{chooseWidget(props.overview.lb)}</Card>
            </Grid>
            <Grid item xs={12} sm={12} md={12} lg={6}>
                <Card style={cardStyle}>{chooseWidget(props.overview.rb)}</Card>
            </Grid>
        </Grid>
    );
}
