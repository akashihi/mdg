...
--rollback DELETE FROM ERROR WHERE CODE='ACCOUNT_NOT_FOUND';
--rollback DELETE FROM ERROR WHERE CODE='ACCOUNT_DATA_INVALID';
--rollback DELETE FROM ERROR WHERE CODE='ACCOUNT_NOT_UPDATED';
