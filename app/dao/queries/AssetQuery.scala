...
object AssetQuery {
  /**
    ...
    */
  def getTotalAssetsForDate(term: LocalDate, includeHidden: Boolean = false)(implicit ec: ExecutionContext): DBIO[BigDecimal] = {
    ...
    sql"""
         ...
         where a.account_type='asset' and a.hidden=$includeHidden and tx.ts <  $dt"""
